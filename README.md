...
<img src="[![LeetCode](https://shields.io)](https://leetcode.com/u/Smit_patel63)
&label=Profile%20Views&color=0D9488&style=for-the-badge" />
...
<p align="center">
<img src="https://github-readme-streak-stats.herokuapp.com/?user=smitpatel63&theme=tokyonight&border_radius=10&hide_border=true"/>
</p>

<p align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=smitpatel63&theme=tokyo-night&hide_border=true&area=true"/>
</p>

<p align="center">
<img src="https://github-profile-trophy.vercel.app/?username=smitpatel63&theme=algolia&row=2&column=4&margin-w=10&margin-h=10"/>
</p>
...
|---|---|---|
| 🛒 **GA4 E-Commerce Product Analytics** | End-to-end pipeline: cleaning → SQL → BI → predictive stats | `Python` `PostgreSQL` `Power BI` |
| 🧠 Stroke Prediction Analysis | EDA, hypothesis testing, and classification modeling | `Python` `Pandas` `scikit-learn` |
| 📉 Customer Churn Prediction | Feature engineering + churn classification | `Python` `SQL` |
| 📊 Executive Sales Dashboard | Multi-page BI dashboard for leadership reporting | `Power BI` `DAX` |
| ⚙️ Event Recommendation Engine | REST API serving personalized recommendations | `FastAPI` `PostgreSQL` |
